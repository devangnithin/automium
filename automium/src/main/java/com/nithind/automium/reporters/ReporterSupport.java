...
public class ReporterSupport {
    ...
    private static String getHtmlReport() {
        ...
        for (Map.Entry<String, AutomiumLog> entry : ReporterSupport.classLogs.entrySet())
        {
    ...
    public static void setClassLogs(AutomiumLog classLogs) {
        ReporterSupport.classLogs.put(classLogs.getClassName(), classLogs);
    }
}
